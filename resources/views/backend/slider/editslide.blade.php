                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills ml-auto">
                                    <li class="nav-item">
                                        <a class="btn btn-success btn-sm" href="{{route('sliders.view')}}" ><i class="fa fa-plus-circle"></i> Go Back</a>
                                    </li>
                                </ul>
                            </div>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form enctype="multipart/form-data" id="mySlider" method="post" action="{{route('sliders.update',['id'=>$slider->id])}}">
                                {{csrf_field()}}
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="shorttext">Short Description</label>
                                        <textarea name="shorttext" id="shorttext" cols="2" rows="1" class="form-control">{!! $slider->shorttext !!}</textarea>
                                        @error('shorttext')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="longtext" id="longtext" cols="2" rows="1" class="form-control">{!! $slider->longtext !!}</textarea>
                                        @error('longtext')
                                        <span class="text-warning">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <img id="oldimage" class="img-fluid" src="{{asset('public/upload/sliders/'.$slider->image)}}" alt="">
